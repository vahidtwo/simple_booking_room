    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_per_min', models.DecimalField(decimal_places=2, default=0.5, max_digits=6)),
                ('description', models.TextField(blank=True, null=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='book_room', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('book_room', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='booked_room', to='book.bookroom')),
